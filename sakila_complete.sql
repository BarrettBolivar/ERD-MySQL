...
Your query should return customer first name, last name, email, and address.
	SELECT CONCAT(customer.first_name," ", customer.last_name), customer.email, address.address, address.address2, address.district, address.location
	FROM city
...
Your query should return the actor id, actor name, film title, description, and release year.
	SELECT actor.actor_id, actor.first_name, film.film_id, film.title, film.description, film.release_year 
	FROM actor
